...
1. Сложнее контролировать подлинность данных
2. Сложнее отладить получение данных с агентов
...
1. Менее производительный сбор метрик
2. Сложнее реплицировать данные в разные системы мониторинга
